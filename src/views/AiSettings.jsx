  ...
  return (
    <div
      className={`rounded-card border bg-white p-5 shadow-card ${
        provider.isActive ? 'border-brand-400 ring-1 ring-brand-200' : 'border-surface-line'
      }`}
    >
      ...
      {!isMock && (
        <div className="mt-5 border-t border-surface-line pt-5">
          {provider.source === 'environment' ? (
            <p className="rounded-lg border border-surface-line bg-surface-sunken px-4 py-3 text-sm text-ink-muted">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-surface-line bg-surface-sunken px-4 py-3">
              <div>
...
const AiSettings = () => {
  ...
  return (
    <div className="container-page max-w-3xl py-10">
      ...
      <div className="mb-6 rounded-lg border border-surface-line bg-white p-4 text-sm text-ink-muted">
        <p>
