  ...
  return (
    <div className="container-page max-w-3xl py-10">
      ...
      <div className="overflow-hidden rounded-card border border-surface-line bg-white shadow-card">
        <div className="relative aspect-[4/3] bg-board">
          {cameraOn && (
            <video
              ref={videoRef}
              autoPlay
          ...
          {analysing && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-board/70">
      ...
      {predictions.length > 0 && (
        <div className="mt-6 rounded-card border border-surface-line bg-white p-5 shadow-card">
          ...
          <div className="mt-5 border-t border-surface-line pt-5">
            ...
            <Button
              className="mt-4"
              fullWidth
              onClick={() => router.push(`/projects?material=${encodeURIComponent(category)}`)}
              disabled={!category}
            >
