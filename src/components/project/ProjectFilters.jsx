...
const selectClass =
  'w-full rounded-lg border border-surface-line bg-white px-3 py-2 text-sm transition-colors hover:border-brand-300';
...
const ProjectFilters = ({
  ...
  return (
    <div className="rounded-card border border-surface-line bg-white p-4 shadow-card sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-surface-line bg-white py-2.5 pl-10 pr-20 text-sm transition-colors hover:border-brand-300"
          />
          <div className="absolute right-2 top-1/2 flex -translate-y-1/2 items-center gap-1">
            {searchInput && (
              <button
                ...
                className="tap-target inline-flex items-center justify-center rounded-full p-1.5 text-ink-subtle transition-colors hover:bg-surface-sunken hover:text-ink"
              >
                ✕
              </button>
            )}
            {voice.supported && (
              <button
                ...
                className={`tap-target inline-flex items-center justify-center rounded-full p-1.5 transition-colors ${
                  voice.listening
      ...
      {expanded && (
        <div id="filter-panel" className="mt-4 border-t border-surface-line pt-4">
