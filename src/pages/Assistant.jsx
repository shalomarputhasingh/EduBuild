...
const Assistant = () => {
  ...
  return (
    <div className="container-page max-w-3xl py-10">
      ...
      <div className="flex min-h-[26rem] flex-col rounded-card border border-slate-200 bg-white shadow-card">
              ...
              <div className="mx-auto mt-4 flex max-w-xl flex-col gap-2">
                {SUGGESTIONS.map((suggestion) => (
                  <button
                    ...
                    className="rounded-lg border border-slate-200 px-4 py-3 text-left text-sm text-ink-muted transition-colors hover:border-brand-300 hover:bg-brand-50 hover:text-ink"
                  >
                    {suggestion}
                  </button>
                ))}
            ...
            >
              ...
              >
                {message.role === 'assistant' ? (
                  <div className="space-y-2 [&_a]:text-brand-700 [&_a]:underline [&_code]:rounded [&_code]:bg-slate-200 [&_code]:px-1 [&_h2]:mt-3 [&_h2]:font-bold [&_h3]:mt-3 [&_h3]:font-semibold [&_li]:ml-4 [&_li]:list-disc [&_ol_li]:list-decimal [&_strong]:font-semibold">
        ...
        >
          ...
          <input
            ...
            maxLength={2000}
            className="min-w-0 flex-1 rounded-lg border border-slate-300 px-4 py-2.5 text-sm transition-colors hover:border-slate-400"
          />
